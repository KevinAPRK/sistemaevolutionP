...
function Especialidades({ servicios }) {
  ...
  return (
    <PageWrapper handleWhatsAppDirect={handleWhatsAppDirect}>
      <div className="pt-28 md:pt-32 pb-16 md:pb-24 min-h-screen bg-[#fafafa] relative overflow-hidden">
        ...
        <section className="px-4 sm:px-6 max-w-7xl mx-auto mb-12 md:mb-16 relative">
          <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 items-stretch">
            <div className="bg-white/90 backdrop-blur rounded-[2rem] md:rounded-[3rem] shadow-xl border border-white p-6 sm:p-8 md:p-12">
              ...
              <h2 className="text-4xl md:text-7xl font-black tracking-tighter text-[#414242] leading-[0.95]">
        ...
        <section className="px-4 sm:px-6 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {specialties.map((specialty, index) => (
              <article key={specialty.name} className="group bg-white rounded-[2rem] md:rounded-[2.75rem] shadow-sm border border-[#c9c8c6]/25 p-6 md:p-9 flex flex-col h-full relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl">
