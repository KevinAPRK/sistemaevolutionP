      ...
      <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
        ...
        {!articulo ? (
          ...
          <article className="bg-white rounded-[2rem] shadow-lg border border-[#c9c8c6]/30 overflow-hidden">
            {articulo.imagen_url && <img src={articulo.imagen_url} alt={articulo.titulo} className="w-full h-96 object-cover" />}
            <div className="p-10 md:p-16">
              ...
              <h1 className="text-3xl md:text-4xl font-black mb-6 text-[#414242]">{articulo.titulo}</h1>
              <p className="text-lg font-medium text-[#414242]/70 mb-8 italic border-l-4 border-[#dbac43] pl-4">{articulo.resumen}</p>
              <div className="text-[#414242]/80 text-lg leading-relaxed space-y-6">
